...
const TeachersAddBulk = (props: Props) => {
  const { t } = useT();
          ...
          <div className='border-b border-violet-200 bg-violet-50 px-5 py-4'>
            <div className='flex flex-wrap items-center justify-between gap-3'>
              <div className='min-w-0'>
                <p className='text-xs font-medium uppercase tracking-wide text-violet-600'>{t('add_teacher_account')}</p>
                <h3 className='mt-0.5 truncate text-xl font-semibold text-slate-800'>
                  {t('bulk_add_teacher_accounts')}
                </h3>
              </div>
              <Button
                type='button'
...
export default TeachersAddBulk;
